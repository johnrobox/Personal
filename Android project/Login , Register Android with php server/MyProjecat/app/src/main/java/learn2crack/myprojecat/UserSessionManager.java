...
public class UserSessionManager {
    ...
    public static final String KEY_USER_API_TOKEN = "token";
    ...
    public void createUserLoginSession(String token){
        ...
        editor.putString(KEY_USER_API_TOKEN, token);
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        // user token
        user.put(KEY_USER_API_TOKEN, pref.getString(KEY_USER_API_TOKEN, null));
